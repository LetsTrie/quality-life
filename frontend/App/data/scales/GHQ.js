...
export default {
  questions: [
    ...
    {
      question:
        'আপনি কি বর্তমানে কোন কিছু সম্পর্কে সিদ্ধান্ত গ্রহণ করতে সমর্থ?',
      options: getAnswers([1, 1, 0, 0]),
    },
    {
    ...
    {
      question:
        'আপনার কি মনে হয় ইদানিং আপনার অসুবিধাগুলি দূর করতে সক্ষম হচ্ছেন না?',
      options: getAnswers([0, 0, 1, 1]),
    },
    {
    ...
    {
      question:
        'সবদিক বিবেচনা করে বর্তমানে আপনি কি নিজেকে মোটামুটিভাবে সুখী মনে করেন?',
      options: getAnswers([1, 1, 0, 0]),
    },
  ],
};
