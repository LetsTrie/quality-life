...
const AskForTest = ({ navigation, route }) => {
  let { link, type, preTest } = route.params;
  let testInfo = testData.find((t) => t.id === link);

  const [modalVisible, setModalVisible] = useState(false);

  function getDetails() {
    if (testInfo.title === 'মানসিক অবস্থা যাচাইকরণ') {
      return [
    ...
    } else if (testInfo.title === 'মানসিক চাপ নির্ণয়') {
      return [
        ':::Stress / মানসিক চাপ কি ?',
...
● এত লম্বা সময় ধরে চাপ সামাল দেওয়ার কারণে গুরুতর মানসিকভাবে বিপর্যস্ততা।`,
      ...
      return [
        ':::Anxiety/উদ্বেগ/ দুশ্চিন্তা কাকে বলে ?',
        ...
        >
          ...
          <View style={styles.container}>
            ...
            <View style={styles.description}>
              <Text style={styles.descriptionText}>{testInfo.description}</Text>
            </View>
            <View style={styles.description}>
              <Text style={styles.copyrightText}>{testInfo.copyright}</Text>
            </View>
            <View>
              <Button
                title='Take Test'
                onPress={() => navigation.navigate('Test', { ...route.params })}
              />
              <Button
                title='See History'
                onPress={() =>
