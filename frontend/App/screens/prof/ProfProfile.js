...
const MyProfileScreen = () => {
        ...
        return clients.map((client, index) => (
            <View
                ...
                style={[
                    ...
                    index + 1 === clients.length && { borderBottomWidth: 0 },
                ]}
            >
    ...
    if (isFetching) return <Loader style={{ marginTop: 20 }} />;
    ...
    return (
        <ScrollView style={{ paddingBottom: 10 }}>
            ...
            <View style={styles.sectionContainer}>
                ...
                <View style={[styles.detailRow, { paddingBottom: 3 }]}>
                    <Text style={[styles.detailKey, { paddingBottom: 2 }]}>
                        Specialization Area:
                    </Text>
                ...
                {data.otherSpecializationArea && (
                    <View style={[styles.detailRow, { paddingBottom: 3 }]}>
                        ...
                        <Text style={styles.detailValue}>
                            {data.otherSpecializationArea || 'N/A'}
                        </Text>
                    </View>
                )}
                <View style={[styles.detailRow, { paddingBottom: 3 }]}>
