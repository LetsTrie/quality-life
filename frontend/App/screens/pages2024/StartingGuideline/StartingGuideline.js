        ...
        <ScrollView style={styles.scrollView}>
            ...
            <View style={styles.card}>
                <Text style={styles.descText}>
                    এই মোবাইল এপ্লিকেশনটি একটি ব্যাতিক্রমধর্মী উদ্যোগ যার মাধ্যমে আপনার মানসিক
                    স্বাস্থ্যের অবস্থা যাচাই করতে পারবেন। এতে মানসিক অবস্থা উন্নয়নের সহজ পদ্ধতি
                    প্রদান করা হয় এবং প্রয়োজনে মানসিক স্বাস্থ্য সেবা প্রদানকারীর সাথে যোগাযোগের
                    ব্যবস্থাও রয়েছে।
                </Text>
                <Text style={[styles.descText, styles.extraSpacing]}>
                    আপনার প্রদত্ত তথ্যের গোপনীয়তা বজায় রাখা আমাদের অগ্রাধিকার। তথ্যগুলো শুধুমাত্র
                    গবেষণা কাজে ব্যবহৃত হবে এবং কেবলমাত্র তিনজন গবেষকের জন্য উপলব্ধ থাকবে। অনুগ্রহ
                    করে প্রশ্ন এবং রেটিং মনোযোগ দিয়ে পূরণ করুন।
                </Text>
            </View>
