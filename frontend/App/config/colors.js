export default {
  primary: '#BD8C6A', // Soft Terracotta - warmth and comfort (kept as requested)
  secondary: '#5A7A6D', // Deep Sage Green - grounded elegance
  black: '#3A2E2A', // Deep Warm Brown - soft alternative to pure black
  white: '#FFFFFF',
  ...
  overlay: '#F5EDE5', // Soft Transparent Overlay with more luminosity
  textPrimary: '#4A3A2A', // Deep Warm Brown - rich, readable
  textSecondary: '#6E5A4A', // Soft Muted Brown - complementary
  textInverse: '#FFFFFF',
  focus: '#BD8C6A', // Matching Primary Color as Focus Indicator
  tableHeader: '#BD8C6A', // Matching Primary Color
};
